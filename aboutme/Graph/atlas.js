(function(){
    ...
    var that = {
      ...
      redraw:function(){
        ...
        particleSystem.eachEdge(function(edge, pt1, pt2){
          ...
          if (!color || (""+color).match(/^[ \t]*$/)) color = "#00FF00"
  ...
  var Maps = function(elt){
    ...
    var _sources = {
      states:'Developed By <a target="_blank" href="https://www.facebook.com/pnaditya">Aditya Pn</a>'
      
    }

    var _maps = {
      asia:{title:"Aditya Pn's Chain", p:{stiffness:500}, source:_sources.states},
    ...
    var that = {
      ...
      selectMap:function(map_id){
        // "+map_id+"
        $.getJSON("/aboutme/Graph/asia.json",function(data){
